...
#include "core/source_tree_loader/config.hpp"
#include "core/source_file_info_loaders/config.hpp"
#include "core/source_tree_loader/command_dictionary.hpp"
...
namespace Maike
{
	...
	std::map<std::string, std::reference_wrapper<SourceFileInfoLoaders::Loader const>, std::less<>>
