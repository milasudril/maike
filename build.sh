...
cat << '+xk`BD+)I~>gu?*!4i+CBg<]9k~Q5C:{$nd/.P<W' > '__targets/maikeconfig.json'
{
    ...
    "targetinfo":{
        ...
        "linux_string":"4.4.0-78-lowlatency",
        "nullfile":"/dev/null",
        "posix":200809,
        "project_root":"",
