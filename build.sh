...
'g++' '-c' '-g' '-fpic' '-std=c++11' '-Wall' '-Woverflow' '-Wconversion' '-Werror' '-o' '__targets/targetcxxpkgconfig.o' 'targetcxxpkgconfig.cpp'
...
'g++' '-g' '-fpic' '-std=c++11' '-Wall' '-Woverflow' '-Wconversion' '-Werror' '-shared' '-o' '__targets/targetpython.so' 'targetpythonmain.cpp' '__targets/targetpythonhook.o' '__targets/targetpythonfactory.o' '__targets/targetpython.o' '__targets/targetbase.o' '__targets/timedscope.o' '__targets/dependency.o' '__targets/pathutils.o' '__targets/targetpythonloader.o' '__targets/filein.o' '__targets/targetpythoninterpreter.o' '__targets/thread.o' '-lpthread' '__targets/command.o' '__targets/resourceobject.o' '-ljansson' '__targets/pipe.o' '__targets/writebuffer.o' '__targets/stdstream.o' '__targets/fileout.o' '__targets/strerror.o' '__targets/exceptionhandler.o' '__targets/errormessage.o' '__targets/stringformat.o'
