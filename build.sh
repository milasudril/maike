...
g++ -g -fpic -std=c++11 -Wall -Woverflow -Wconversion -Werror -o __targets/./maike ./maike-main.cpp __targets/./datasinkstd.o __targets/./options.o __targets/./expressionevaluatordefault.o __targets/./systemtargetinfo.o __targets/./sysvars.o __targets/./versionnumber.o __targets/./target_factorydelegatordefault.o __targets/./targetpythonfactory.o __targets/./targetpython.o __targets/./targetpythonloader.o __targets/./targetpythoninterpreter.o __targets/./targetcxxfactory.o __targets/./targetcxx.o __targets/./targetcxxcompiler.o __targets/./thread.o -lpthread __targets/./targetcxxloader.o __targets/./targetcxxpptokenizer.o __targets/./filein.o __targets/./targetcxxoptions.o __targets/./parametersetdefault.o __targets/./command.o __targets/./pipe.o __targets/./targetdirectoryloader.o __targets/./targetdirectory.o __targets/./fileutils.o __targets/./maike.o __targets/./maikeinfo.o __targets/./writebuffer.o __targets/./spiderdefault.o __targets/./fileinfo.o __targets/./directorylister.o __targets/./strerror.o __targets/./dependencygraphdefault.o __targets/./targetbase.o __targets/./dependency.o __targets/./resourceobject.o __targets/./exceptionhandler.o __targets/./errormessage.o __targets/./stringformat.o -ljansson
