//@	{"targets":[{"name":"targetcploader.o","type":"object"}]}
...
Handle<Target> TargetCPLoader::targetCreate(const ResourceObject& obj
	,const char* name_src,const char* in_dir,const char* root
	,size_t id,size_t line_count) const
	{
	return Handle<TargetCP>( TargetCP::create(obj,name_src,in_dir,root
		,id,line_count) );
	}
...
void TargetCPLoader::targetsLoad(const char* name_src,const char* in_dir
