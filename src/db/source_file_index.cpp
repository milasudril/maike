                                                                           ...
                                                                           SourceFileInfo&& info)
{
	...
	auto const i =
	   m_by_path.insert(std::make_pair(std::move(path), std::make_pair(id, std::move(info))));
...
std::vector<Maike::Db::SourceFileIndex::RecordConst>
Maike::Db::getRecordsById(SourceFileIndex const& index)
{
