...
#include "src/source_file_loader.hpp"
...
namespace Maike::Cxx
{
	...
	inline auto filterInput(SourceFileLoader const& loader, Reader input, SourceOutStream source_stream, TagsOutStream tag_stream)
	{
