	...
	class PRIVATE TargetOctave final : public Maike::TargetBase
		...
		public:
			static TargetOctave* create(const ResourceObject& obj
				,const TargetOctaveInterpreter& compiler,const char* name_src
				,const char* in_dir,const char* root,size_t id,size_t line_count);

			static TargetOctave* create(const ResourceObject& obj
				,TargetOctaveInterpreter&& compiler,const char* name_src
		...
		private:
			...
			TargetOctave(const ResourceObject& obj
				,TargetOctaveInterpreter&& intpret,const char* name_src
				,const char* in_dir,const char* root,size_t id
				,size_t line_count)=delete;
