...
TargetPythonLoader::TargetPythonLoader(const TargetPythonInterpreter& intpret): r_intpret(intpret)
{
}
...
{
	return Handle<TargetPython>(
	   TargetPython::create(obj, r_intpret, name_src, in_dir, root, id, line_count));
}
...
void TargetPythonLoader::dependenciesExtraGet(const char* name_src,
                                              const char* in_dir,
                                              const char* root,
...
void TargetPythonLoader::targetsLoad(const char* name_src,
                                     const char* in_dir,
                                     Spider& spider,
