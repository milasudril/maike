//@	{"targets":[{"name":"targetbash.o","type":"object"}]}
...
TargetBash::TargetBash(const ResourceObject& obj,
...
void TargetBash::dumpDetails(ResourceObject& target) const
{
...
bool TargetBash::upToDate(Twins<const Dependency*> dependency_list,
...
void TargetBash::compileImpl(Twins<const Dependency*>,
                             Twins<const Dependency*>,
...
TargetBash::~TargetBash() noexcept
{
}


TargetBash* TargetBash::create(const ResourceObject& obj,
                               const TargetBashInterpreter& intpret,
                               const char* name_src,
                               const char* in_dir,
                               const char* root,
                               ...
                               size_t line_count)
{
	return new TargetBash(obj, intpret, name_src, in_dir, root, id, line_count);
}

void TargetBash::destroy() noexcept
{
	delete this;
}
