...
TargetOctaveLoader::TargetOctaveLoader(const TargetOctaveInterpreter& intpret): r_intpret(intpret)
{
}
...
{
	return Handle<TargetOctave>(
	   TargetOctave::create(obj, r_intpret, name_src, in_dir, root, id, line_count));
}
...
void TargetOctaveLoader::dependenciesExtraGet(const char* name_src,
                                              const char* in_dir,
                                              const char* root,
...
void TargetOctaveLoader::targetsLoad(const char* name_src,
                                     const char* in_dir,
                                     Spider& spider,
