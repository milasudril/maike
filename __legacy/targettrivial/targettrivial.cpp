...
TargetTrivial::TargetTrivial(const Command& cmd,
                             const char* name,
                             const char* name_src,
                             const char* in_dir,
                             const char* root,
                             ...
                             const char* target_dir) const
{
	...
	if(!dependenciesProcess(target_dir, dependencies(), USE_TOOL | USE_MISC, up_to_date)) { return 0; }
...
TargetTrivial* TargetTrivial::create(const Command& cmd,
                                     const char* name,
                                     const char* name_src,
                                     const char* in_dir,
                                     const char* root,
