...
namespace Maike
{
	...
	class PRIVATE Target_FactoryDelegatorDefault final:
	   public Target_FactoryDelegator,
	...
	public:
		...
		void targetsCreate(TagExtractor& extractor,
		                   const char* name_src,
		                   const char* in_dir,
		...
		Target& dependencyResolve(DependencyGraph& graph, const char* target_from, const Dependency& dep);
		...
		void
		targetsLoad(const char* filename, const char* in_dir, Spider& spider, DependencyGraph& targets);
	...
	private:
		void targetsCreateImpl(TagExtractor& extractor,
		                       const char* name_src,
		                       const char* in_dir,
		                       const Target_Loader& loader_current,
		                       Spider& spider,
