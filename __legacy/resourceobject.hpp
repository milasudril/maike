...
namespace Maike
{
	...
	public:
		...
		public:
			...
			Iterator(Iterator&& i) noexcept: r_vtable(i.r_vtable), r_owner(i.r_owner), m_handle(i.m_handle)
			{
				i.m_handle = nullptr;
			}
		...
		ResourceObject(ResourceObject&& tree) noexcept: r_vtable(tree.r_vtable), m_handle(tree.m_handle)
		{
	...
	protected:
		...
		ResourceObject(const Vtable& vtable, void* handle) noexcept: r_vtable(&vtable), m_handle(handle)
		{
		}
