...
The latest release version can can be found at [the github release page][1]. The former may contain features not present in the later, while the later should be used if there is no sufficiently recent version of Maike installed.
